...
export const APP_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/executive-os/envelope", label: "Envelope", icon: "Home" },
      ...
      { href: "/executive-os/closeout", label: "Closeout", icon: "PackageCheck" },
      { href: "/executive-os/warranty", label: "Warranty", icon: "BadgeCheck" },
